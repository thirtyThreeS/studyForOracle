...
public class ComplexNumber
{
    ...
    {
        // * Method named add with one parameter of type ComplexNumber. It needs to add (method) the ComplexNumber parameter (complexNumber) to the
        // corresponding instance variables (real, imaginary) getters in this case.
